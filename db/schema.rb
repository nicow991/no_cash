...
ActiveRecord::Schema[7.1].define(version: 2024_03_21_182811) do
  ...
  create_table "items_offers", force: :cascade do |t|
  ...
  add_foreign_key "items_offers", "items"
  add_foreign_key "items_offers", "offers"
